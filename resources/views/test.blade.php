    ...
    <form action="{{ @route('test-check') }}"
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">Заполните пропуск в предложиении</h3>
            </div>
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">Заполните пропуск в слове</h3>
            </div>
            <div class="panel-body">
                <div class="form-group row">
                    <div class="col-7">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">Выбрать перевод слова на русский язык</h3>
            </div>
            <div class="panel-body">
                <div class="form-group row">
                    <div class="col-7">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">Напечатать перевод слова на русский язык</h3>
            </div>
            <div class="panel-body">
                <div class="form-group row">
                    <div class="col-7">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">Напечатать перевод слова на английский язык</h3>
            </div>
            <div class="panel-body">
                <div class="form-group row">
                    <div class="col-7">
        ...
        <hr>
        <button type="submit"
                class="btn btn-primary mb-2">Проверить
        </button>
    </form>
@endsection
